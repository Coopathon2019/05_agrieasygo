  ...
  <v-app>
    ...
    <v-container fluid>
      <v-row class="px-12" style="height: 120px;" align="end" justify="start">
        <h1 class="display-1 font-weight-black light-green--text text--darken-4">您打算發佈什麼樣的課程?</h1>
      </v-row>
        ...
        <v-row class="px-12" align="center" justify="center">
          ...
          <v-col cols="12" md="6">
            <v-text-field
              ...
              label="專案金額(元)"
              required
              @input="$this.cdollar.$touch()"
              @blur="$this.cdollar.$touch()"
            ></v-text-field>
          </v-col>
          ...
          <v-col cols="12" md="6">
            <v-text-field
              ...
              label="農場體驗次數"
              required
              @input="$this.cfre.$touch()"
              @blur="$this.cfre.$touch()"
            ></v-text-field>
          </v-col>
          <v-col cols="12" md="6">
          ...
          <v-btn color="lime darken-2" class="mr-4" @click="submit">
            <span class="title white--text font-weight-black">課程上架</span>
          </v-btn>
...
export default {
  ...
  data() {
    return {
      ...
      cname: "美美的紅鬚玉米筍Ａ",
      ctype: "玉米筍",
      ctime: "2020-05-11 12:0:0",
      cdollar: "",
      cnum: "20",
      cfre: "",
      ctext: "採取有機農法進行耕作",
      cmail: "farmer@gmail.com"
    };
  },
